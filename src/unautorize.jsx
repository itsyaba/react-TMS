...
function unautorize() {
  return (
    <div className="unaute-container">
      <div id="container">
        <div className="toph">
          <h1 className="error-name">ERROR </h1>
          <h1 className="number error-name">403</h1>
        </div>

        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1278 1080">
          <defs>
            <style>
              .cls-4{`fill:#ff9}.cls-5{fill:#acedfc}.cls-10{fill:#68af2f`}
              .cls-12{`opacity:0.61`}.cls-13{`fill:#fff`}.cls-16{`fill:#5a5e5e`}
            </style>
        ...
        <h1 className="error-name">FORBIDDEN</h1>
        <div id="details">
